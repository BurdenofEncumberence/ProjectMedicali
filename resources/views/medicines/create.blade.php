            ...
            <div class="med-card" style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div class="field-group">
                    ...
                    <div class="image-upload-area" onclick="document.getElementById('imageInput').click()">
                        ...
                        <p style="font-size:0.8rem; color:#9FE1CB; margin-top:8px;">Click to upload an image</p>
                ...
                <div class="grid-2">
                    <div class="field-group">
                        ...
                        <input type="text" name="brand" value="{{ old('brand') }}"
                               placeholder="e.g. Unilab" class="med-input">
                    </div>
                    <div class="field-group">
                ...
                <div class="grid-3">
                    <div class="field-group">
                        ...
                        <input type="number" name="price" value="{{ old('price') }}" step="0.01" min="0"
                               placeholder="0.00" class="med-input">
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <input type="number" name="reorder_level" value="{{ old('reorder_level', 10) }}" min="1"
                               class="med-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <input type="date" name="expiry_date"
                           ...
                           value="{{ old('expiry_date') }}" class="med-input">
                </div>
